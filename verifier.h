...
// the error source distinguishes between errors parsing the puzzle file, errors
// parsing the solution file, errors parsing the metric, and errors encountered
